...
For UK and Norway the local record is itself free - route to **`companies-house-uk`** and **`norway-company-registry`**. For a full compliance workflow, route to **`regdata-kyc-aml`**. Paid actors use a free Apify token: https://console.apify.com/sign-up?ref=getregdata.
