---
name: regdata
description: "Router for European government registry data extraction across Poland, Spain, Austria, and France. Use when the user wants to check a company in Europe, extract government registry data, verify a business entity, look up beneficial owners, check insolvency records, find company directors, or scrape official public registries. Also use when the user mentions: 'european company data', 'government registry', 'regdata', 'polish business data', 'austrian company data', 'french company data', 'spanish company data', 'check a company in Europe', 'KRS', 'KNF', 'CRBR', 'BDO', 'BORME', 'EKW', 'UOKiK', 'MSiG', 'KRZ', 'eKRS', 'WKO', 'Ediktsdatei', 'Societe.com', 'dane z rejestrow', 'sprawdz firme', 'rejestr przedsiebiorcow', 'polnische Firmendaten', 'Unternehmensdaten', 'Handelsregister', 'datos de empresa', 'registro mercantil', 'donnees entreprise', 'registre du commerce'. This is the discovery entry point - it identifies user intent and routes to the correct specialized skill."
metadata:
  version: 1.0.0
  author: regdata
